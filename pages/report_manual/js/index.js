...
function fetchDeposit(start_date, end_date) {
  ...
  let resWithdrawReport = callXMLHttpRequest(
    `${apiPort.apiQueryTransactionManual}`,
  ...
  if (resWithdrawReport.statusCodeText == textRespone.ok.CodeText) {
    ...
    for (let i = 0; i < data.length; i++) {
      ...
      tableData.push([
        ...
        data[i].module == "Deposit"
          ? '<span style="color:green">ฝากเงิน</span>'
          : '<span style="color:red">ถอนเงิน</span>',
        data[i].cr_by,

...
$(document).ready(async function() {
    ...
    localStorage.removeItem("huay_g_id");
    localStorage.removeItem("huay_t_id");
    localStorage.removeItem("huay_date_find");
});
...
async function handleRenderContent() {
    ...
    let result = await callXMLHttpRequest(`${apiPort.apiQueryLottoGroupType}`, dataReq);
    let amount = 0;
    let affiliate = 0;
    let winner_amount = 0;
    let net_amount = 0;
        ...
        if (result.data) {
            ...
            result.data.forEach((item, key) => {
                ...
                <div class="card-header">
                  ...
                  <div class="row mt-2">
                    <div class="col-6 col-sm-3">
                      <span class="badge badge-primary w-100">ยอดพนัน<br>${formatMoney(item2.amount)}</span>
                    </div>
                    <div class="col-6 col-sm-3">
                      <span class="badge badge-danger w-100">affiliate<br>${formatMoney(item2.aff)}</span>
                    </div>
                    <div class="col-6 col-sm-3">
                      <span class="badge badge-danger w-100">ถูกรางวัล<br>${formatMoney(item2.winner)}</span>
                    </div>
                    <div class="col-6 col-sm-3">
                      <span class="badge badge-success w-100">ยอดสุทธิ<br>${formatMoney(item2.total)}</span>
                    </div>
                  </div>
                </div>
                 <div class="card-body">
              <div class="row">
                ...
                <div class="col-6 mt-1">
                  <button onclick="callTotalHuay(2,${item.lotto_group_id},${item2.id},'${dataReq.lottoDate}')" class="btn btn-success btn-block">ยอดตามหมายเลข</button>
                </div>
                <div class="col-6 mt-1">
                  <button onclick="callTotalHuay(3,${item.lotto_group_id},${item2.id},'${dataReq.lottoDate}')" class="btn btn-danger btn-block">ยอดตามสมาชิก</button>
                </div>
              </div>
                </div>
                </div>
              ...
              <div class="card shadow" style="border-radius: 0px !important;">
                <div class="card-header">
                  ...
                  <div class="row mt-2">
                    <div class="col-6 col-sm-3">
                      <span class="badge badge-primary w-100">ยอดพนัน<br>0.00</span>
                    </div>
                    <div class="col-6 col-sm-3">
                      <span class="badge badge-danger w-100">affiliate<br>0.00</span>
                    </div>
                    <div class="col-6 col-sm-3">
                      <span class="badge badge-danger w-100">ถูกรางวัล<br>0.00</span>
                    </div>
                    <div class="col-6 col-sm-3">
                      <span class="badge badge-success w-100">ยอดสุทธิ<br>0.00</span>
                    </div>
                  </div>
                </div>
                 <div class="card-body">
                    <div class="row">
                      <div class="col-6 mt-1">
                        <a href="#" class="btn btn-primary btn-block">ยอดตามประเภท</a>
                      </div>
                      <div class="col-6 mt-1">
                        <a href="#" class="btn btn-success btn-block">ยอดตามหมายเลข</a>
                      </div>
                      <div class="col-6 mt-1">
                        <a href="#" class="btn btn-danger btn-block">ยอดตามสมาชิก</a>
                      </div>
                    </div>
                </div>
                </div>
...
async function callTotalHuay(mode, g_id, t_id, date) {
    ...
    window.location.replace('/pages/report_consolidate_account/total_huay.html');
}